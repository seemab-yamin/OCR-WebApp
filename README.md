...
[OCR WebApp Demo](https://youtu.be/qkMXNliMgt4)

## Live API (Lambda)

- **API Docs (Swagger):** [https://hdy4pxpducg2kuinyf34nwjd2e0ojfbn.lambda-url.us-east-1.on.aws/docs](https://hdy4pxpducg2kuinyf34nwjd2e0ojfbn.lambda-url.us-east-1.on.aws/docs)
...
aws ecr get-login-password --region us-east-1 | docker login --username AWS --password-stdin 182399721343.dkr.ecr.us-east-1.amazonaws.com

docker tag ocr-webapp-api:latest 182399721343.dkr.ecr.us-east-1.amazonaws.com/ocr-webapp-mvp:api

docker push 182399721343.dkr.ecr.us-east-1.amazonaws.com/ocr-webapp-mvp:api
...
docker build -f Dockerfile.worker -t ocr-webapp-worker .
